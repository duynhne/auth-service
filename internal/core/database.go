...
type DatabaseConfig struct {
	Host           string // DB_HOST - PostgreSQL host (e.g., "auth-db-pooler.auth.svc.cluster.local")
	Port           string // DB_PORT - PostgreSQL port (default: 5432)
	Name           string // DB_NAME - Database name (e.g., "auth")
	User           string // DB_USER - Database user
	// nolint:gosec // G117: This is a credential field for database connection
